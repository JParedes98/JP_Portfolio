...
<div>
    <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
        <h2 class="text-2xl font-bold md:text-4xl md:leading-tight">noc noc</h2>
    ...
    <div class="group relative flex gap-x-5">
        ...
        <div class="grow pb-8 group-last:pb-0">
            ...
            <div class="mt-3">
                <!-- Card -->
                <a class="block border border-gray-200 rounded-lg hover:shadow-sm focus:outline-none" href="#">
